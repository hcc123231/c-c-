...
void array_testcase(int cfd){
    ...
    testCase(cfd,"DEL TEA","ok\r\n","test11");*/
    testCase(cfd, "SET Teacher King", "ok\r\n", "SET-Teacher");
	testCase(cfd, "GET Teacher", "King\r\n", "GET-Teacher");
    testCase(cfd, "MOD Teacher Darren", "ok\r\n", "MOD-Teacher");
	testCase(cfd, "GET Teacher", "Darren\r\n", "GET-Teacher");
	testCase(cfd, "EXIST Teacher", "exist\r\n", "GET-Teacher");
	testCase(cfd, "DEL Teacher", "ok\r\n", "DEL-Teacher");
	testCase(cfd, "GET Teacher", "not exist\r\n", "GET-Teacher");
	testCase(cfd, "MOD Teacher KING", "not exist\r\n", "MOD-Teacher");
	testCase(cfd, "EXIST Teacher", "not exist\r\n", "GET-Teacher");
